 ...
 * @var iterable<\App\Model\Entity\Disciplina> $disciplinas
 */
?>
<div class="disciplinas index content">
    <?= $this->Html->link(__('New Disciplina'), ['action' => 'add'], ['class' => 'button float-right']) ?>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('idProfessor') ?></th>
